(() => {
    ...
    const settings = (0, s.getSetting)('tradesafe-relay_data', {});
    const label = (0, e.decodeEntities)(settings.title) || (0, i.__)('Relay', 'tradesafe-relay_payment_gateway');
