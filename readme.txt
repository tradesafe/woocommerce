...
* Updated dokan withdraw settings page to display registred banking details

= 2.15.1 2024-02-01 =

### Bug Fixes

* Force dokan to use default payout frequency when updating wethdrawal settings
