...
class WC_Gateway_TradeSafe extends WC_Payment_Gateway
{
     ...
     *
     */
    public function generate_setup_details_html($key, $data)
    {
        $urls = array(
                ...
                <div class="details-box plugin-details">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><?php esc_attr_e($ping_result['api']['domain']);
                                esc_attr_e(' [' . ($ping_result['api']['status'] ? 'OK' : 'ERROR') . ']') ?></td>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td><?php esc_attr_e($ping_result['auth']['domain']);
                                esc_attr_e(' [' . ($ping_result['auth']['status'] ? 'OK' : 'ERROR') . ']') ?></td>
                        </tr>
                        <?php
