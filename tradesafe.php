...
define( 'TRADESAFE_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'TRADESAFE_PLUGIN_NAME', dirname( plugin_basename( __FILE__ ) ) );
define( 'TRADESAFE_PLUGIN_BASE_NAME', plugin_basename( __FILE__ ) );
